       ...
       <>
            ...
            <body>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <h3 id="sectionLM_Summary">Line Manager Summary</h3> 
                    
                    <div id="LMSummaryContent">
                        <p>Line Manager summary content</p>
                    </div>

                    {/* SECTION 4: LINE MANAGER */}
                    <h3 id="sectionHead4">SECTION 4: Additional Approval</h3> 
                    ...
                    <div id="sectionContent4">
                        ...
                        <div class="checkbox-item AdditionalApprovalDC">
                            <input 
                                type="checkbox" 
                        ...
                        <h3>HEAD OF COMPLIANCE(ONLY REQUIRED IN CASE OF CONSULTATION)</h3>

                        <div id="HOCComent">
                            <div>
                        
                                <textarea type="text" id="HOCcommentVal" rows={10} placeholder="enter.."></textarea>
                        ...
                        <div>
                            <label htmlFor="HOCname">Name(s): 
                                <input type="text" id="HOCname" name="HOCname" placeholder="enter name.." />
                            </label> 
                        </div>
                        <div>
                            <label htmlFor="HOCname">Last name:
                                <input type="text" id="HOCname" name="HOCname" placeholder="enter last name.." />
                            </label> 
                        </div>
                        <div>
                            <label htmlFor="HOCdepartment">Department:
                                <input type="text" id="HOCdepartment" name="HOCdepartment" placeholder="enter department" />
                            </label>
                        </div>
...
export default AdditionalApproval;